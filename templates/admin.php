...
<div class="wrap zci-settings-wrap">
    ...
    <h2 class="nav-tab-wrapper">
        <a href="?page=zci_settings&tab=settings" class="nav-tab <?php echo $active_tab == 'settings' ? 'nav-tab-active' : ''; ?>"><?php _e('Settings', 'categories-images'); ?></a>
        <a href="?page=zci_settings&tab=documentation" class="nav-tab <?php echo $active_tab == 'documentation' ? 'nav-tab-active' : ''; ?>"><?php _e('Documentation', 'categories-images'); ?></a>
    </h2>
        ...
        <?php else : ?>
            ...
            <div class="zci-main-column">
                <div class="zci-card zci-documentation">
                    <h2><?php _e('Usage and Documentation', 'categories-images'); ?></h2>
